...
${GOPATH}/src/github.com/ahmetb/gen-crd-api-reference-docs/gen-crd-api-reference-docs \
 -config "${GOPATH}/src/github.com/ahmetb/gen-crd-api-reference-docs/example-config.json" \
 -api-dir "github.com/argoproj/argo-events/pkg/apis/subscription/v1alpha1" \
 -out-file "${GOPATH}/src/github.com/argoproj/argo-events/api/subscription.html" \
 -template-dir "${GOPATH}/src/github.com/ahmetb/gen-crd-api-reference-docs/template"
...
pandoc --from markdown --to gfm ${GOPATH}/src/github.com/argoproj/argo-events/api/subscription.html > ${GOPATH}/src/github.com/argoproj/argo-events/api/subscription.md
