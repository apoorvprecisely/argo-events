...
import (
	v1alpha1 "github.com/argoproj/argo-events/pkg/apis/subscription/v1alpha1"
...
var subscriptionsResource = schema.GroupVersionResource{Group: "argoproj.io", Version: "v1alpha1", Resource: "subscriptions"}

var subscriptionsKind = schema.GroupVersionKind{Group: "argoproj.io", Version: "v1alpha1", Kind: "Subscription"}
