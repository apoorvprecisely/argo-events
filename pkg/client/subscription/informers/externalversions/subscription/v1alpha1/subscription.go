...
import (
	...
	versioned "github.com/argoproj/argo-events/pkg/client/subscription/clientset/versioned"
	internalinterfaces "github.com/argoproj/argo-events/pkg/client/subscription/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/argoproj/argo-events/pkg/client/subscription/listers/subscription/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ArgoprojV1alpha1().Subscriptions(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ArgoprojV1alpha1().Subscriptions(namespace).Watch(options)
			},
		},
