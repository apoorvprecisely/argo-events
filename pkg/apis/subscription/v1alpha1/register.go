...
import (
	"github.com/argoproj/argo-events/pkg/apis/subscription"
...
var SchemeGroupVersion = schema.GroupVersion{Group: subscription.Group, Version: "v1alpha1"}

// SchemaGroupVersionKind is a group version kind used to attach owner references to sensor executor job
var SchemaGroupVersionKind = schema.GroupVersionKind{Group: subscription.Group, Version: "v1alpha1", Kind: subscription.Kind}
