...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NATSProtocol) DeepCopyInto(out *NATSProtocol) {
	*out = *in
	if in.SubscriptionRef != nil {
		in, out := &in.SubscriptionRef, &out.SubscriptionRef
		*out = new(Subscription)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NATSProtocol.
func (in *NATSProtocol) DeepCopy() *NATSProtocol {
	if in == nil {
		return nil
	}
	out := new(NATSProtocol)
