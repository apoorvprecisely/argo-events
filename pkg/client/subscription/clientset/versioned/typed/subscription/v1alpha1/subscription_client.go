...
import (
	...
	"github.com/argoproj/argo-events/pkg/client/subscription/clientset/versioned/scheme"
...
func (c *ArgoprojV1alpha1Client) Subscriptions(namespace string) SubscriptionInterface {
